        ...
        <Card className="relative overflow-hidden border-primary/25 bg-gradient-to-r from-primary/10 via-secondary/80 to-background shadow-lg">
          ...
          <CardHeader className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="space-y-2">
              <Badge className="bg-white/70 text-primary border border-primary/30">현재 플랜</Badge>
              <div className="flex items-center gap-2">
                <Crown className="w-6 h-6 text-primary" />
                <CardTitle className="text-2xl md:text-3xl">{activePlan.name}</CardTitle>
              </div>
              <CardDescription className="text-base">{activePlan.description}</CardDescription>
            </div>
              ...
              <Button
                ...
                onClick={() => {
                  toast({
                    ...
                    description: "billing@safefriends.test로 전송됨",
                  });
                }}
              >
          ...
          <CardContent className="grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl bg-white/70 border border-border/70 p-4 shadow-sm">
              ...
              <p className="text-lg font-semibold text-foreground">
                {currentPlan === "basic" ? "결제 예정 없음" : `${nextBillingDate} · 12,000원/월`}
              </p>
              <p className="text-xs text-muted-foreground">플랜 변경 시 다음 주기부터 반영</p>
            </div>
            ...
            <div className="rounded-2xl bg-white/70 border border-border/70 p-4 shadow-sm space-y-2">
              ...
              <div className="flex items-end justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">이미지 보호 한도</p>
                </div>
            ...
            <div className="rounded-2xl bg-white/70 border border-border/70 p-4 shadow-sm space-y-2">
              ...
              <div className="flex items-end justify-between">
                <p className="text-lg font-semibold text-foreground">{aiEdits}회 사용</p>
        ...
        <div className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
          <Card className="border border-border/70 shadow-md">
            <CardHeader>
              ...
              <CardDescription>청구 메일과 결제 수단을 확인하고 변경할 수 있어요.</CardDescription>
            </CardHeader>
            <CardContent className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-border/70 p-4 space-y-2 bg-secondary/60">
                ...
                <p className="font-semibold text-foreground">billing@safefriends.test</p>
                <Button
                  variant="ghost"
                  size="sm"
                  className="px-0"
              ...
              <div className="rounded-xl border border-border/70 p-4 space-y-2 bg-secondary/60">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-semibold text-foreground">국민카드 • 0921</p>
                    <p className="text-xs text-muted-foreground">만료 2026.03</p>
                  </div>
                  <Badge variant="outline" className="border-primary/30 text-primary">
                    기본
                  </Badge>
          ...
          <Card className="border border-border/70 shadow-md">
            <CardHeader>
              ...
              <CardDescription>요금이 어떻게 계산되는지 한눈에 확인하세요.</CardDescription>
            </CardHeader>
        ...
        <div ref={planSectionRef} className="space-y-3">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <h2 className="text-2xl font-bold text-foreground">내게 맞는 플랜으로 전환</h2>
            </div>
            <Badge variant="secondary" className="bg-primary/10 text-primary border-primary/30">
              기존 팝업과 동일한 혜택 제공
            </Badge>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-baseline gap-1 mb-4">
                    ...
                    {plan.priceNote && <span className="text-sm font-semibold text-muted-foreground">{plan.priceNote}</span>}
                  </div>
                  ...
                  <Button
                    ...
                    variant={isActive ? "secondary" : plan.highlight ? "primary" : "outline"}
                    size="lg"
